...
namespace StudentDetails
{
    class UserInterFace : interfaceuseraction
    {
            ...
            do
            {
                ...
                switch (op)
                {
                    case 1:
                        ...
                        Console.WriteLine("Task completed successfully...  you may Exit....!");
                        break;
                    case 2:

                        this.showStudentRegistrationScreen();
                        Console.WriteLine("Tak Completed successfully ...you may Exit....!");
                        break;
                    case 3:
                ...
                Console.WriteLine("Do you want to continue on Student Phase:Yes or No");
                res = Console.ReadLine();
            } while ((res == "YES") || (res == "yes"));
        }
        ...
        public void showStudentRegistrationScreen() // Execute the register method of AppEngine class
        {
            ...
            engine.studentregister(new Student(name, id, dob));
        }
